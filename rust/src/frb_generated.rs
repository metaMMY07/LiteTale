...
fn wire__crate__api__font__decode_chapter_font_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "decode_chapter_font",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, flutter_rust_bridge::for_generated::anyhow::Error>(
                    (move || {
                        let output_ok = crate::api::font::decode_chapter_font(api_data)?;
                        Ok(output_ok)
                    })(),
                )
            }
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__font__decode_chapter_font_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__wenku8__delete_all_history_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__wenku8__delete_bookcase_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__wenku8__delete_download_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__wenku8__delete_history_by_novel_id_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        14 => wire__crate__api__system__desktop_root_impl(port, ptr, rust_vec_len, data_len),
        15 => wire__crate__api__wenku8__download_checkcode_impl(port, ptr, rust_vec_len, data_len),
