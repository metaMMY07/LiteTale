...
Future<void> deleteHistoryByNovelId({required String novelId}) =>
    RustLib.instance.api.crateApiWenku8DeleteHistoryByNovelId(novelId: novelId);
...
Future<String> getApiHost() => RustLib.instance.api.crateApiWenku8GetApiHost();

Future<void> setApiHost({required String apiHost}) =>
    RustLib.instance.api.crateApiWenku8SetApiHost(apiHost: apiHost);
